...
public class AlertVisualStyle: NSObject {
     ...
     */
    public func actionColor(for action: AlertAction?) -> UIColor { return UIColor.clear }
     ...
     */
    public func actionHighlightColor(for action: AlertAction?) -> UIColor { return UIColor(white: 0.8, alpha: 0.7) }
